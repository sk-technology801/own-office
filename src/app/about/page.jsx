  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.95), rgba(0, 0, 0, 0.95)), url('https://images.unsplash.com/photo-1516321310762-7d9b5f3b7b1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')`,
        }}
      >
        <div className="text-center px-4 sm:px-6 lg:px-8 z-10">
          ...
          <Link
            href="/get-started"
            className="inline-block bg-transparent border-2 border-blue-400 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg hover:bg-blue-400/20 transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_20px_rgba(59,130,246,0.8)]"
          >
            Get Started
          </Link>
        </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950 relative overflow-hidden">
        <div
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex justify-center mb-8 sm:mb-12">
            <div className="flex bg-gray-900 rounded-lg p-1 gap-1 sm:gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 sm:px-6 sm:py-3 rounded-md font-medium text-sm sm:text-base transition-all duration-300 ${
                    activeTab === tab.id
                      ? 'bg-white text-black shadow-[0_0_10px_rgba(59,130,246,0.5)]'
          ...
          <div className="min-h-[300px] sm:min-h-[400px]">
            {activeTab === 'story' && (
              <div className="animate-fade-in text-center">
                <img
                  src="https://images.unsplash.com/photo-1516321310762-7d9b5f3b7b1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                  alt="Our Story"
                  className="w-full max-w-md mx-auto mb-6 sm:mb-8 rounded-lg opacity-0 animate-fade-in group-hover:scale-105 transition-transform duration-300"
                />
                <h2 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-white text-shadow-glow">Our Journey</h2>
                <div className="max-w-4xl mx-auto">
                  <p className="text-base sm:text-lg text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                    Founded in 2019, CodeZap began as a small team of passionate developers who believed technology should solve real problems. From humble beginnings, we’ve grown into a global software house.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12">
                    {[
                      ...
                      <div
                        key={index}
                        className="p-4 sm:p-6 bg-gray-900 rounded-lg hover:bg-gray-800 transition-all duration-300 hover:shadow-[0_0_10px_rgba(59,130,246,0.3)]"
                      >
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
                    {[
                      ...
                      <div
                        key={index}
                        className="p-6 sm:p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300"
                      >
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12">
                    {[
                      ...
                      <div
                        key={index}
                        className="p-4 sm:p-6 bg-gray-900 rounded-lg hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_10px_rgba(59,130,246,0.3)]"
                      >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-300">The principles that guide everything we do</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              {
                icon: 'https://images.unsplash.com/photo-1516321310762-7d9b5f3b7b1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
                title: 'Innovation',
              ...
              },
              {
                ...
                title: 'Excellence',
                description: 'Highest standards in code and user experience.',
              },
              {
                icon: 'https://images.unsplash.com/photo-1516321310762-7d9b5f3b7b1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
                title: 'Collaboration',
                description: 'Teamwork and open communication with clients.',
              },
              {
                icon: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
                title: 'Integrity',
                description: 'Transparency and honesty in all we do.',
              },
            ].map((value, index) => (
              <div
                key={index}
                className="group p-6 sm:p-8 bg-gray-900 rounded-xl text-center hover:bg-gray-800 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] animate-fade-in-up"
                style={{ animationDelay: `${index * 150}ms` }}
              >
                <img
                  src={value.icon}
                  alt={value.title}
                  className="w-12 sm:w-16 h-12 sm:h-16 mx-auto mb-4 rounded-full opacity-0 animate-fade-in group-hover:scale-110 transition-transform duration-300"
                />
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-300">Our track record speaks for itself</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              {
              ...
              <div
                key={index}
                className="text-center p-6 sm:p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl hover:from-gray-800 hover:to-gray-700 transition-all duration-500 hover:scale-105 animate-fade-in"
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900 to-purple-900 relative overflow-hidden">
        <div
          className="absolute inset-0 opacity-20"
          style={{
            backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(255, 255, 255, 0.2) 2px, transparent 2px)',
            backgroundSize: '20px 20px',
          }}
        />
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/get-started"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-blue-400 text-white font-semibold rounded-lg hover:bg-blue-400/20 transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_15px_rgba(59,130,246,0.7)]"
            >
              Start a Project
            </Link>
            <Link
              href="/portfolio"
              className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-black transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,255,255,0.7)]"
            >
              View Our Work
            </Link>
          </div>
